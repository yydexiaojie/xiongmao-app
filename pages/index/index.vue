<template>
	<view class="content">
		<!-- <swiper class="swiper" circular :indicator-dots="true" :autoplay="true" :interval="2000"
			...
			<swiper-item>
				<view class="swiper-item" style="background: green;">B</view>
			</swiper-item>
			<swiper-item>
		...
		<view class="main">
			<view class="fast-goto">
				<view class="fast-main">
					<view class="fast-main-block fast-main-left">
...
<style scoped>
	...
	.fast-main {
		...
		flex-direction: row;
		padding: 4rpx;
		border-bottom: 3rpx #f6f7f9 solid;
	...
	.fast-main > .fast-main-block:last-child {
		margin-right: 0rpx;
	}
	.fast-main-left {
		background: #A6AAE3;
	...
	.fast-tip-label {
		padding: 6rpx 10rpx;
		font-size: 16rpx;
		background: linear-gradient(#f9a50f, #f77213);
		border-radius: 6rpx;
		color: #fff;
	}
	.space-30 {
